...
{/* SCREENSHOT: the actual output on your screen — save as ./images/step-8-add-the-expected-output.png, then replace this line with: ![Step 8: Add the expected output](./images/step-8-add-the-expected-output.png) */}
