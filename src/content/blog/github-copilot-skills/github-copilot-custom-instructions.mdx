...
description: 'GitHub Copilot custom instructions explained simply — what the file is, why every project needs one, and the mistakes beginners make when writing it.'
