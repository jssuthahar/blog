...
description: 'A build-along tutorial for .NET developers — create one complete GitHub Copilot Skill (SKILL.md) that enforces Clean Architecture, CQRS, and your API contract.'
