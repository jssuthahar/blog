...
description: 'Everything that actually belongs in an AGENTS.md file — architecture, security, testing, AI-specific rules — plus what to leave out, common mistakes, whether Copilot can write it for you, and a full reusable template.'
...
One approach, stated plainly. This is one of the highest-leverage sections in the whole file. If every feature handles failure differently, every feature also gets tested and reviewed differently.
