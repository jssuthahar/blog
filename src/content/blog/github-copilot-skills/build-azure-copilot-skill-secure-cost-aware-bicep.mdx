...
description: 'A build-along tutorial: create one GitHub Copilot Skill (SKILL.md) that guards your Azure Bicep — Managed Identity, private networking, and cost tiers Copilot will not violate.'
