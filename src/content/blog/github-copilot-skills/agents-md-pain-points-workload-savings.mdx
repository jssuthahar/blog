...
description: 'AI coding agents now write more code every month than most teams can review by hand. AGENTS.md is the one file that keeps that code consistent — for solo devs, teams, and enterprises.'
