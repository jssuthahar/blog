...
seoTitle: 'GitHub Copilot Azure Skill for Bicep'
...
faq:
  - q: 'Can a GitHub Copilot Skill enforce cloud security policy?'
    a: 'Yes, at authoring time. A Skill encodes hard rules — Managed Identity over keys, secrets in Key Vault, public network access disabled — that Copilot follows when it writes Bicep, so the insecure default never gets typed. It is a preventive control in the editor, not runtime enforcement: pair it with Azure Policy.'
...
{/* SCREENSHOT: the portal screen you used — save as ./images/why-an-azure-copilot-skill-is-different-gu.png, then replace this line with: ![Why an Azure Copilot Skill is different: guardrails, not generated code](./images/why-an-azure-copilot-skill-is-different-gu.png) */}
...
{/* SCREENSHOT: the portal screen you used — save as ./images/azure-specific-gotchas-the-skill-should-en.png, then replace this line with: ![Azure-specific gotchas the Skill should encode](./images/azure-specific-gotchas-the-skill-should-en.png) */}
