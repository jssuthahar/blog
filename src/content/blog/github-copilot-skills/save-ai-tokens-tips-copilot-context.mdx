...
seoTitle: 'How to Save AI Tokens: 15 Copilot Tips'
...
{/* SCREENSHOT: your real usage or billing view — save as ./images/why-does-a-long-ai-chat-cost-so-much.png, then replace this line with: ![Why does a long AI chat cost so much](./images/why-does-a-long-ai-chat-cost-so-much.png) */}
