...
description: 'How to safely change legacy code with GitHub Copilot using characterization tests, the Strangler Fig pattern, and deterministic hook and CI gates so a fast AI refactor cannot silently break behavior.'
