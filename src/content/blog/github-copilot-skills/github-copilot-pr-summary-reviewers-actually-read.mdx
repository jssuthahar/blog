...
description: 'A software architect on the GitHub Copilot PR summary: why an auto-generated pull request description that restates the diff is noise, and how to get one reviewers actually read.'
